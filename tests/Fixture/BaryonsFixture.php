 ...
 *
 */
class BaryonsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_oneway' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'is_private' => 1,
            'user_id' => 1,
            'created' => '2017-04-19 02:48:44',
            'modified' => '2017-04-19 02:48:44'
        ],
    ];
}
